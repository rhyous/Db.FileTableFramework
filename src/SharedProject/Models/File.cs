...
namespace Rhyous.Db.FileTableFramework
{
    public class File
    {
#pragma warning disable IDE1006 // Naming Styles - Because we are matching the column names in FileTables exactly
        public Guid stream_id { get; set; }
        public byte[] file_stream { get; set; }
        public string name { get; set; }
        public SqlHierarchyId path_locator { get; set; }
        public SqlHierarchyId parent_path_locator { get; set; }
